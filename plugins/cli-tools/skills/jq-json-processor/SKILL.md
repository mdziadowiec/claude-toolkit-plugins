...
description: Process, filter, and transform JSON data using jq - the lightweight and flexible command-line JSON processor. Use this skill whenever the user wants to query, filter, reshape, extract fields from, or transform JSON data using jq expressions, whether from files, API responses, or piped input.
